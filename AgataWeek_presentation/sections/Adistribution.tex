	...
	\begin{columns}
		\begin{column}{0.43\textwidth}
			\begin{overlayarea}{\textwidth}{\textheight}
				\centering
				\vspace{0.015\textheight}
				\only<1>{\includegraphics[width=\textwidth]{ELabVsThetaLab_0}}   				\only<2>{\includegraphics[width=\textwidth]{ELabVsThetaLab_1}}
			\end{overlayarea}
		\end{column}
		\begin{column}{0.57\textwidth}
			\begin{overlayarea}{\textwidth}{\textheight}
				\centering       
				\only<1>{\includegraphics[width=\textwidth]{Ex_0}}				 				\only<2>{\includegraphics[width=\textwidth]{Ex_1}}
		    \end{overlayarea}	
		\end{column}
	\end{columns}
\end{frame}